...
*/
// pode colocar tudo junto, mas a gente teve que colocar separado para treinar
// push = empurrar; "empurra" um valor para dentro da array
...
*/
// atribuir outro valor para um elemento da array
...
*/
const foodsInfo = `Até aqui, o array "brazilianFoods" possui ${brazilianFoods.length} itens: ${brazilianFoods[0]}, ${brazilianFoods[1]} 
e ${brazilianFoods[2]}.`
...
*/
// join muda a forma que a array aparece no console
...
*/
dogNames.pop() //apaga o último elemento de uma array
...
*/
//template string é o negócio de concatenação com `` ${}
dogNames.push('Nina')
...
//console.log(`${dessert} é um doce à base de coco, tradicional na América Latina e em Angola.`)
...
oddNumbers[1] += 4
//oddNumbers[1] = oddNumbers[1] ** 3 //** eleva o numero ao próximo que vir, nesse caso é elevado a 3
oddNumbers[1] = Math.pow(oddNumbers[1],3) // biblioteca Math para elevar um númedo
